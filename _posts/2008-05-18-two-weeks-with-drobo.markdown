...
The <a href="http://cdn.clickontyler.com/blog/drobo-faceplate.jpg" style="float:right;" class="lightbox"><img src="http://cdn.clickontyler.com/blog/drobo-faceplate-sm.jpg"></a> faceplate that you remove to access the drives is magnetic. It pulls off and snaps into place with a satisfying _thwpp_. Also, the inside of the faceplate has a quick reference chart of what Drobo's various status lights mean.
...
It's <a href="http://cdn.clickontyler.com/blog/drobo-side.jpg" style="float:right;" class="lightbox"><img src="http://cdn.clickontyler.com/blog/drobo-side-sm.jpg"></a> bigger than I expected. In hindsight, I should have anticipated the size considering it has to be big enough to hold four hard drives plus room for a fan and circuitry. Still, it's definitely not pint sized.
