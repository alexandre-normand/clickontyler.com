	...
	else
	{
		if($row['dt'] > '2011-01-02 00:00:00')
		{
			...
			else
			{
				...
				$out .= "<p>Yay! You qualified for a free upgrade to Nottingham 2.0. We have emailed an upgraded license key to you at " . $row['payer_email'] . ". Enjoy!</p>";
		...
		{
			$out .= "<p>Our records show that you have already upgraded to Nottingham 2.0. If you think this is a mistake, or just need help <a href='/support/'>looking up a lost license</a>, feel free to contact us at <a href='mailto:support@clickontyler.com'>support@clickontyler.com</a>.</p>";
		}
	}
?>
